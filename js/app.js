...
// Анимация текста
var typed22363456 = new Typed(".home__typed", {
  strings: [
    "Качественная работа, соблюдение сроков, адекватные цены.",
    "jQuery, БЭМ, Flexbox, Grid, Gulp, Pug, SCSS, PixelPerfect.",
    "Figma, Photoshop, Zeplin.",
    "Адаптивная верстка, Анимация, Parallax-эффекты.",
    "Кроссбраузерность, Отзывчивость, Валидность, Useability, Google Page Speed 95+.",
  ],
...
function scroll_scroll() {
  ...
  if (scr_blocks.length > 0) {
    for (let index = 0; index < scr_blocks.length; index++) {
      ...
      if (
        src_value > block_offset - block_height &&
        src_value < block_offset + block_height &&
        window.innerHeight > scr_min_height &&
...
let slider_works = new Swiper(".slider-works__body", {
  autoplay: {
    delay: 3000,
  ...
  // Arrows
  navigation: {
    nextEl: ".works .slider-works-arrows_next",
    prevEl: ".works .slider-works-arrows_prev",
  },
...
let slider_coding = new Swiper(".slider-coding__body", {
  autoplay: {
    delay: 3000,
    disableOnInteraction: false,
  },
  ...
  // Arrows
  navigation: {
    nextEl: ".coding .slider-coding-arrows_next",
    prevEl: ".coding .slider-coding-arrows_prev",
  },
